...
func TestCORS_PreflightRequest(t *testing.T) {
	...
	Expect(response.Header().Get("Access-Control-Allow-Origin")).Equals("https://app.example.com")
	Expect(response.Header().Get("Access-Control-Allow-Methods")).Contains("POST")
	Expect(response.Header().Get("Access-Control-Allow-Methods")).Contains("GET")
	Expect(response.Header().Get("Access-Control-Allow-Methods")).Contains("PUT")
	Expect(response.Header().Get("Access-Control-Allow-Methods")).Contains("PATCH")
	Expect(response.Header().Get("Access-Control-Allow-Methods")).Contains("DELETE")
	Expect(response.Header().Get("Access-Control-Allow-Methods")).Contains("OPTIONS")
	Expect(response.Header().Get("Access-Control-Allow-Headers")).Contains("Authorization")
	Expect(response.Header().Get("Access-Control-Allow-Headers")).Contains("Content-Type")
	Expect(response.Header().Get("Access-Control-Allow-Headers")).Contains("X-Tenant-ID")
	Expect(response.Header().Get("Access-Control-Allow-Credentials")).Equals("true")
